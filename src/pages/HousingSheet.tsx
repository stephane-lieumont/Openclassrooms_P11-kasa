 ...
 */
const HousingSheet: React.FunctionComponent = () => {
  ...
  return (
    <Fragment>
      {isLoading ? (
        ...
        <Fragment>
          <div id="heading">
            <HeadPictures heightSize={HeightSize.large} isLoading={sliderIsLoading}>
              <Carousel
                pictures={housingData?.pictures}
                title={housingData?.title}
                handleLoad={handleLoadedPictures}
              />
            </HeadPictures>
          </div>
            ...
            <div className="housing">
              <div className="housing__title">
                ...
                <ul className="housing__tags">
                  {housingData?.tags.map((tag, index) => <li key={index}>{tag}</li>)}
                </ul>
              </div>
              <aside className="housing__author">
                ...
                <Stars count={housingData?.rating || 0} />
              </aside>
            </div>
          </section>
          <section id="details">
